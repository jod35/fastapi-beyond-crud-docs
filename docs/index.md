...
My name is **Ssali Jonathan**, a software engineer based in Uganda. For the past five years, I’ve been building a [YouTube channel](https://youtube.com/@SsaliJonathan) where I teach programming, with a strong focus on Python.
...
I also produce music for fun in my free time using [FL Studio](https://www.image-line.com/flstudio/).
